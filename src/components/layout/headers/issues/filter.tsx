...
import { status as allStatus } from '@/src/tests/test-data/status';
import { priorities } from '@/src/tests/test-data/priorities';
import { labels } from '@/src/tests/test-data/labels';
                     ...
                     <CommandGroup>
                        {allStatus.map((item) => (
                           ...
                           >
                              ...
                              {filters.status && filters.status.includes(item.id) && (
                  ...
                  <CommandList>
                     ...
                     <CommandGroup>
                        ...
                        >
                           ...
                           {filters.assignee && filters.assignee.includes('unassigned') && (
                              <CheckIcon size={16} className="ml-auto" />
                           )}
                           <span className="text-muted-foreground text-xs">
                        ...
                        {users.map((user) => (
                           ...
                           >
                              ...
                              {filters.assignee && filters.assignee.includes(user.id) && (
                                 <CheckIcon size={16} className="ml-auto" />
                              )}
                              <span className="text-muted-foreground text-xs">
                     ...
                     <CommandGroup>
                        {priorities.map((item) => (
                           ...
                           >
                              ...
                              {filters.priority && filters.priority.includes(item.id) && (
                                 <CheckIcon size={16} className="ml-auto" />
                              )}
                              <span className="text-muted-foreground text-xs">
                     ...
                     <CommandGroup>
                        {labels.map((label) => (
                           ...
                           >
                              ...
                              {filters.labels && filters.labels.includes(label.id) && (
                                 <CheckIcon size={16} className="ml-auto" />
                              )}
                              <span className="text-muted-foreground text-xs">
                     ...
                     <CommandGroup>
                        {projects.map((project) => (
                           ...
                           >
                              ...
                              {filters.project && filters.project.includes(project.id) && (
                                 <CheckIcon size={16} className="ml-auto" />
                              )}
                              <span className="text-muted-foreground text-xs">
