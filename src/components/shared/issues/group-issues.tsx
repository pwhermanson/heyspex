...
import { useViewStore } from '@/src/state/store/view-store';
...
import { useCreateIssueStore } from '@/src/state/store/create-issue-store';
import { sortIssuesByPriority } from '@/src/tests/test-data/issues';
      ...
      >
         <AnimatePresence>
            {isOver && (
               ...
               >
                  <div className="bg-background border border-gray-200 dark:border-gray-700 rounded-md p-3 shadow-md max-w-[90%]">
