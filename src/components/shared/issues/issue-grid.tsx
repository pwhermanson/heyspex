...
function IssueDragPreview({ issue }: { issue: Issue }) {
   return (
      <div className="w-full p-3 bg-background rounded-md border border-gray-200 dark:border-gray-700/50 overflow-hidden">
   ...
   return (
      <ContextMenu>
         <ContextMenuTrigger asChild>
            <motion.div
               ref={ref}
               className="w-full p-3 bg-background rounded-md shadow-xs border border-gray-200 dark:border-gray-700/50 cursor-default"
