import { LayoutView, ScreenType, KeyboardShortcut } from '@/store/layout-config-store';
...
export function isUniqueViewName(name: string, existingViews: LayoutView[], excludeId?: string): boolean {
...
export function sanitizeViewForStorage(view: LayoutView): Omit<LayoutView, 'createdAt' | 'updatedAt'> & { createdAt: string; updatedAt: string } {
  return {
    ...view,
...
export function restoreViewFromStorage(viewData: Omit<LayoutView, 'createdAt' | 'updatedAt'> & { createdAt: string; updatedAt: string }): LayoutView {
  return {
    ...viewData,
